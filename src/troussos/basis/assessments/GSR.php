 ...
 * Class GSR
 *
 * A class to represent glavanic skin response. This class extends the AssessmentBase
 * class and implements GSR specific methods.
 *
 * @see AssessmentBase Assessment Base Class
 * @link http://en.wikipedia.org/wiki/Skin_conductance Galvanic Skin Response Information
 *
...
class GSR extends AssessmentBase
{
     ...
     * @param int $interval Interval to how far apart each assessment is (e.g. 60 means they are 1 minute apart)
