<?php
/**
 * A base class for all of the assessments to extend.
 *
 * This class holds all of the common proterties and methods that all of the
 * assessments share. All of the assessments can extend this class and use
 * it as a base class.
 *
 * PHP version 5.3
 *
